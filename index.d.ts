...
declare namespace SecurityHelperPlugin {
  class SecurityType {
    size: number;
    items: string[];
  ...
  class Roles extends SecurityType {}

  class Names extends SecurityType {
...
declare module "pouchdb-security-helper" {
  interface Plugin {
    Security: SecurityHelperPlugin.Security;
    security(doc?: SecurityHelperPlugin.PartialSecurityDocument): SecurityHelperPlugin.Security;
  }
